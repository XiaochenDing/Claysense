...
from data.dataset_wholeworkflow import ParametersDataset
...
class ParametersDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None, save=True, test_all=False):  #stage=None, save=True for training
